...
V, (* Vector penguins *) 
 Switch[top,  (* Check topology *) 
  1, 
	 	 ...
	 	 WriteString[sphenoTeX,"  TVO4lVRR= & "<> StringReplace["-16 coup1R coup2R IMP2 Pi^2",SA`SPhenoTeXSub]<>" \\\\ \n" ];
	 	 WriteStringFLB[file,"  TVO4lVLL=TVO4lVLL+ -1*coup1L*coup2L*IMP2\n" ];
	 	 WriteString[sphenoTeX,"  TVO4lVLL= & "<> StringReplace["-16 coup1L coup2L IMP2 Pi^2",SA`SPhenoTeXSub]<>" \\\\ \n" ];
	 	 WriteStringFLB[file,"  TVO4lVRL=TVO4lVRL+ -1*coup1R*coup2L*IMP2\n" ];
	 	 WriteString[sphenoTeX,"  TVO4lVRL= & "<> StringReplace["-16 coup1R coup2L IMP2 Pi^2",SA`SPhenoTeXSub]<>" \\\\ \n" ];
	 	 WriteStringFLB[file,"  TVO4lVLR=TVO4lVLR+ -1*coup1L*coup2R*IMP2\n" ];
	 	 WriteString[sphenoTeX,"  TVO4lVLR= & "<> StringReplace["-16 coup1L coup2R IMP2 Pi^2",SA`SPhenoTeXSub]<>" \\\\ \n" ];
...
,
  2, 
	 	 ...
	 	 WriteString[sphenoTeX,"  TVO4lSRL= & "<> StringReplace["-32 coup1L coup2L IMP2 Pi^2",SA`SPhenoTeXSub]<>" \\\\ \n" ];
	 	 WriteStringFLB[file,"  TVO4lSLR=TVO4lSLR+ -2*coup1R*coup2R*IMP2\n" ];
	 	 WriteString[sphenoTeX,"  TVO4lSLR= & "<> StringReplace["-32 coup1R coup2R IMP2 Pi^2",SA`SPhenoTeXSub]<>" \\\\ \n" ];
	 	 ...
	 	 WriteString[sphenoTeX,"  TVO4lVRL= & "<> StringReplace["-16 coup1L coup2R IMP2 Pi^2",SA`SPhenoTeXSub]<>" \\\\ \n" ];
	 	 WriteStringFLB[file,"  TVO4lVLR=TVO4lVLR+ -1*coup1R*coup2L*IMP2\n" ];
	 	 WriteString[sphenoTeX,"  TVO4lVLR= & "<> StringReplace["-16 coup1R coup2L IMP2 Pi^2",SA`SPhenoTeXSub]<>" \\\\ \n" ];
	 	 WriteStringFLB[file,"  TVO4lTLL=TVO4lTLL+ 0.\n" ];
	 	 WriteString[sphenoTeX,"  TVO4lTLL= & "<> StringReplace["0",SA`SPhenoTeXSub]<>" \\\\ \n" ];
	 	 WriteStringFLB[file,"  TVO4lTLR=TVO4lTLR+ 0.\n" ];
	 	 WriteString[sphenoTeX,"  TVO4lTLR= & "<> StringReplace["0",SA`SPhenoTeXSub]<>" \\\\ \n" ];
...
,
  3, 
	 	 ...
	 	 WriteString[sphenoTeX,"  TVO4lSRL= & "<> StringReplace["32 coup1R coup2L IMP2 Pi^2",SA`SPhenoTeXSub]<>" \\\\ \n" ];
	 	 WriteStringFLB[file,"  TVO4lSLR=TVO4lSLR+ 2*coup1L*coup2R*IMP2\n" ];
	 	 WriteString[sphenoTeX,"  TVO4lSLR= & "<> StringReplace["32 coup1L coup2R IMP2 Pi^2",SA`SPhenoTeXSub]<>" \\\\ \n" ];
	 	 WriteStringFLB[file,"  TVO4lVRR=TVO4lVRR+ -1*coup1R*coup2R*IMP2\n" ];
	 	 WriteString[sphenoTeX,"  TVO4lVRR= & "<> StringReplace["-16 coup1R coup2R IMP2 Pi^2",SA`SPhenoTeXSub]<>" \\\\ \n" ];
	 	 WriteStringFLB[file,"  TVO4lVLL=TVO4lVLL+ -1*coup1L*coup2L*IMP2\n" ];
	 	 WriteString[sphenoTeX,"  TVO4lVLL= & "<> StringReplace["-16 coup1L coup2L IMP2 Pi^2",SA`SPhenoTeXSub]<>" \\\\ \n" ];

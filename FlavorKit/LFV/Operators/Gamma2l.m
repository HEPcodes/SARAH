...
GetInformtion2Fermion1BosonProcess[ChargedLepton,bar[ChargedLepton],Photon,Gamma2l,file]; 
...
WriteString[file,"! 'PreSARAH' output has been generated  at 10:12 on 5.10.2016 \n"]; 
WriteString[file,"! ---------------------------------------------------------------- \n \n"]; 
...
WriteString[file,"! {ChargedLepton, bar[ChargedLepton], Photon} \n "];
WriteString[file,"! ------------------------------ \n \n"];
WriteString[sphenoTeX,"\\section{External states: $"<>TeXOutput[{ChargedLepton[{gt1}], bar[ChargedLepton][{gt2}], Photon[{gt3}]}]<>"$} \n"];

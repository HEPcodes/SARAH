...
WriteString[file,"! 'PreSARAH' output has been generated  at 19:46 on 4.3.2015 \n"]; 
WriteString[file,"! ---------------------------------------------------------------- \n \n"]; 
...
V, (* Vector penguins *) 
 Switch[top,  (* Check topology *) 
  1, 
	 	 ...
	 	 WriteString[sphenoTeX,"  TVOlluuVRR= & "<> StringReplace["-16 coup1R coup2R IMP2 Pi^2",SA`SPhenoTeXSub]<>" \\\\ \n" ];
	 	 WriteStringFLB[file,"  TVOlluuVLL=TVOlluuVLL+ -1*coup1L*coup2L*IMP2\n" ];
	 	 WriteString[sphenoTeX,"  TVOlluuVLL= & "<> StringReplace["-16 coup1L coup2L IMP2 Pi^2",SA`SPhenoTeXSub]<>" \\\\ \n" ];
	 	 WriteStringFLB[file,"  TVOlluuVRL=TVOlluuVRL+ -1*coup1R*coup2L*IMP2\n" ];
	 	 WriteString[sphenoTeX,"  TVOlluuVRL= & "<> StringReplace["-16 coup1R coup2L IMP2 Pi^2",SA`SPhenoTeXSub]<>" \\\\ \n" ];
	 	 WriteStringFLB[file,"  TVOlluuVLR=TVOlluuVLR+ -1*coup1L*coup2R*IMP2\n" ];
	 	 WriteString[sphenoTeX,"  TVOlluuVLR= & "<> StringReplace["-16 coup1L coup2R IMP2 Pi^2",SA`SPhenoTeXSub]<>" \\\\ \n" ];
...
,
  2, 
	 	 ...
	 	 WriteString[sphenoTeX,"  TVOlluuSRL= & "<> StringReplace["-32 coup1L coup2L IMP2 Pi^2",SA`SPhenoTeXSub]<>" \\\\ \n" ];
	 	 WriteStringFLB[file,"  TVOlluuSLR=TVOlluuSLR+ -2*coup1R*coup2R*IMP2\n" ];
	 	 WriteString[sphenoTeX,"  TVOlluuSLR= & "<> StringReplace["-32 coup1R coup2R IMP2 Pi^2",SA`SPhenoTeXSub]<>" \\\\ \n" ];
	 	 ...
	 	 WriteString[sphenoTeX,"  TVOlluuVRL= & "<> StringReplace["-16 coup1L coup2R IMP2 Pi^2",SA`SPhenoTeXSub]<>" \\\\ \n" ];
	 	 WriteStringFLB[file,"  TVOlluuVLR=TVOlluuVLR+ -1*coup1R*coup2L*IMP2\n" ];
	 	 WriteString[sphenoTeX,"  TVOlluuVLR= & "<> StringReplace["-16 coup1R coup2L IMP2 Pi^2",SA`SPhenoTeXSub]<>" \\\\ \n" ];
	 	 WriteStringFLB[file,"  TVOlluuTLL=TVOlluuTLL+ 0.\n" ];
	 	 WriteString[sphenoTeX,"  TVOlluuTLL= & "<> StringReplace["0",SA`SPhenoTeXSub]<>" \\\\ \n" ];
	 	 WriteStringFLB[file,"  TVOlluuTLR=TVOlluuTLR+ 0.\n" ];
	 	 WriteString[sphenoTeX,"  TVOlluuTLR= & "<> StringReplace["0",SA`SPhenoTeXSub]<>" \\\\ \n" ];
...
,
  3, 
	 	 ...
	 	 WriteString[sphenoTeX,"  TVOlluuSRL= & "<> StringReplace["32 coup1R coup2L IMP2 Pi^2",SA`SPhenoTeXSub]<>" \\\\ \n" ];
	 	 WriteStringFLB[file,"  TVOlluuSLR=TVOlluuSLR+ 2*coup1L*coup2R*IMP2\n" ];
	 	 WriteString[sphenoTeX,"  TVOlluuSLR= & "<> StringReplace["32 coup1L coup2R IMP2 Pi^2",SA`SPhenoTeXSub]<>" \\\\ \n" ];
	 	 WriteStringFLB[file,"  TVOlluuVRR=TVOlluuVRR+ -1*coup1R*coup2R*IMP2\n" ];
	 	 WriteString[sphenoTeX,"  TVOlluuVRR= & "<> StringReplace["-16 coup1R coup2R IMP2 Pi^2",SA`SPhenoTeXSub]<>" \\\\ \n" ];
	 	 WriteStringFLB[file,"  TVOlluuVLL=TVOlluuVLL+ -1*coup1L*coup2L*IMP2\n" ];
	 	 WriteString[sphenoTeX,"  TVOlluuVLL= & "<> StringReplace["-16 coup1L coup2L IMP2 Pi^2",SA`SPhenoTeXSub]<>" \\\\ \n" ];

...
SuperFields[[3]] = {Hd, 1, {Hd0, Hdm},  -1/2, 2, 1,     1};
SuperFields[[4]] = {Hu, 1, {Hup, Hu0},   1/2, 2, 1,     1};

SuperFields[[5]] = {d, 3, conj[dR],  1/3, 1, -3,        1};
SuperFields[[6]] = {u, 3, conj[uR], -2/3, 1, -3,        1};
SuperFields[[7]] = {e, 3, conj[eR],    1, 1,  1,      Exp[2*Pi*\[ImaginaryI]/3]};
...
SuperPotential = Yu u.q.Hu - Yd d.q.Hd - Ye e.l.Hd + \[Mu] Hu.Hd + L3/2 u.d.d;

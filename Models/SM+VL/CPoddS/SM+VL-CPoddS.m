...
Model`Name = "SSMVLodd";
Model`NameLaTeX ="Singlet Extended Standard Model (CP-odd) with Vector-Like Quarks";
...
LagNoHC = -(-mu2 conj[H].H +  1/2 MS2 s.s 
            + 1/2 \[Lambda] conj[H].H.conj[H].H 
             + 1/4 lamS s.s.s.s
            + 1/2 lamHS conj[H].H.s.s
            + kapHS conj[H].H.s
            + 1/3 kapS s.s.s 
            );

LagHC = - ( Yd conj[H].d.q + Ye conj[H].e.l - Yu H.u.q 
          + YF1 \[ImaginaryI] s.F1L.F1R + m1F F1L.F1R 
          + YF2 \[ImaginaryI] s.F2L.F2R + m2F F2L.F2R 
          + YF3 \[ImaginaryI] s.F3L.F3R + m3F F3L.F3R 
          + YF4 \[ImaginaryI] s.F4L.F4R + m4F F4L.F4R 
          + YF5 \[ImaginaryI] s.F5L.F5R + m5F F5L.F5R 
          + YF6 \[ImaginaryI] s.F6L.F6R + m6F F6L.F6R 
          + YF7 \[ImaginaryI] s.F7L.F7R + m7F F7L.F7R 
          + YF8 \[ImaginaryI] s.F8L.F8R + m8F F8L.F8R
          + YF9 \[ImaginaryI] s.F9L.F9R + m9F F9L.F9R
          + YF10 \[ImaginaryI] s.F10L.F10R + m10F F10L.F10R
          + YF11 \[ImaginaryI] s.F11L.F11R + m11F F11L.F11R 
          + YF12 \[ImaginaryI] s.F12L.F12R + m12F F12L.F12R
          + YF13 \[ImaginaryI] s.F13L.F13R + m13F F13L.F13R  
          );

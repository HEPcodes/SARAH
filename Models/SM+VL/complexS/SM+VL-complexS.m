...
Model`Name = "SSMVLcomplex";
Model`NameLaTeX ="Complex Singlet Extended Standard Model with vectorlike quarks";
...
LagNoHC = -(-mu2 conj[H].H + MS2 conj[s].s 
           + 1/2 \[Lambda] conj[H].H.conj[H].H 
           + 1/2 lamS conj[s].s.conj[s].s
            + lamHS conj[H].H.conj[s].s 
            );
...
DEFINITION[EWSB][VEVs]= 
 {    {H0, {v, 1/Sqrt[2]}, {sigmaH, \[ImaginaryI]/Sqrt[2]},{phiH, 1/Sqrt[2]}},
      {phi, {vS, 1/Sqrt[2]}, {sigmaS, \[ImaginaryI]/Sqrt[2]},{phiS, 1/Sqrt[2]}}
 };

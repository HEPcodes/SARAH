(* SARAH generated template for particles.m file for NMSSM15 *)
...
{Fdp,{ 
     ...
     Mass -> LesHouches, 
     OutputName -> "fdp", 
     PDG -> {88888896, 88888950}   (* adjusted number of PDGs to number of generations  *), 
     ElectricCharge -> -1/3, 
     Width -> Automatic}}, 
...
{Fep,{ 
     ...
     Mass -> LesHouches, 
     OutputName -> "fep", 
     PDG -> {88888938, 88888952}   (* adjusted number of PDGs to number of generations  *), 
     ElectricCharge -> -1, 
     Width -> Automatic}}, 
...
{Sdp,{ 
     ...
     Mass -> LesHouches, 
     OutputName -> "sdp", 
     PDG -> {88888905, 88888906, 88888955, 88888956}   (* adjusted number of PDGs to number of generations  *), 
     ElectricCharge -> -1/3, 
     Width -> Automatic}}, 
...
{Sep,{ 
     ...
     Mass -> LesHouches, 
     OutputName -> "sep", 
     PDG -> {88888943, 88888944, 88888959, 88888960}   (* adjusted number of PDGs to number of generations  *), 
     ElectricCharge -> -1, 
     Width -> Automatic}}, 
...
{Sup,{ 
     ...
     Mass -> LesHouches, 
     OutputName -> "sup"   , 
     PDG -> {88888969, 88888970, 88888971, 88888972}  , 
     ElectricCharge -> 2/3, 
     Width -> Automatic}} 
}; 

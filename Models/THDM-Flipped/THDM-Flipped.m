...
Model`Name = "THDMFlipped";
Model`NameLaTeX ="Flipped Two Higgs Doublet Model";
...
LagHC = -(M12 conj[H1].H2 + Lambda5/2 conj[H2].H1.conj[H2].H1 + Yd conj[H1].d.q + Ye conj[H2].e.l - Yu H2.u.q);

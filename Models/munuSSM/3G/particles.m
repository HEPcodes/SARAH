ParticleDefinitions[GaugeES] = {
   ...
   ParticleDefinitions[EWSB] = {
      ...
      {hh ,  { Description -> "Higgs",
               PDG -> {25, 35,1000012,1000014,1000016,2000012,2000014,2000016}, 
                 PDG.IX ->{101000001,101000002,101000003,101000004,101000005,101000006,101000007,101000008}}}, 
      {Ah ,  { Description -> "Pseudo-Scalar Higgs",
               PDG -> {0, 36,1000017,1000018,1000019,2000018,2000019,2000020}, 
                 PDG.IX ->{0,102000001,102000002,102000003,102000004,102000005,102000006,102000007}}}, 
      ...
      {Chi,  { Description -> "Neutrinos",
               PDG -> {12,14,16,1000022,1000023,1000025,1000039,1000045,1000055,1000065},
                 PDG.IX ->{211000001,211000002,211000003,211000004,211000005,211000006,211000007,211000008,211000009,2110000010}}},

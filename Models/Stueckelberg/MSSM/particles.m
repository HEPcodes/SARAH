...
ParticleDefinitions[GaugeES] = {
  ...
  ParticleDefinitions[EWSB] = {
      ...
      {Chi,  { Description -> "Neutralinos",
                 PDG -> {1000045,1000055,1000022,1000023,1000025,1000035},
                 PDG.IX -> {211000005,211000006,211000001,211000002,211000003,211000004} }},

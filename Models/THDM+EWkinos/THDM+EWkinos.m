...
Model`Name = "THDMewKinos";
Model`NameLaTeX ="THDM with Electroweakinos";
...
LagNoHC = -(M112 conj[H1].H1 + M222 conj[H2].H2 + Lew1 conj[H1].H1.conj[H1].H1 + \
		Lew2 conj[H2].H2.conj[H2].H2 + Lew3 conj[H2].H2.conj[H1].H1 + Lew4 conj[H2].H1.conj[H1].H2 );


LagHC = -(Lew5/2 conj[H2].H1.conj[H2].H1 + Lew6 conj[H1].H1.conj[H1].H2 + Lew7 conj[H2].H2.conj[H1].H2 + M12 conj[H1].H2  \

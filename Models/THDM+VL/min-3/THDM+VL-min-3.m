...
Model`Name = "minTHDMVL";
Model`NameLaTeX ="Two Higgs Doublet Model I with a minimal amount of vectorlike quarks";
Model`Authors = "F.Staub, M.E. Krauss";
Model`Date = "2016-01-07";

(* model as proposed in 1512.08508. *)
...
(* the idea is that Y[QVL] = Y[SL] + 1/2. Adjust those charge assignments to your needs *)
FermionFields[[6]] = {SL, 1, sL,           2, 1,  3};
FermionFields[[7]] = {SR, 1, conj[sR],    -2, 1, -3};
FermionFields[[8]] = {QVL, 1, {uVL,dVL},                 5/2,  2,  3};  
FermionFields[[9]] = {QVR, 1, {conj[uVR],conj[dVR]},    -5/2, -2, -3};  
...
LagHC = -(M12 conj[H1].H2 + Lambda5/2 conj[H2].H1.conj[H2].H1  + Yd conj[H2].d.q + Ye conj[H2].e.l + Yu H2.u.q 
          + lam1S H1.QVR.SL + lam2S H2.QVR.SL + lam1D conj[H1].SR.QVL + lam2D conj[H2].SR.QVL           
          + MQV QVR.QVL + MS SR.SL + YLFV conj[H1].e.l
          );

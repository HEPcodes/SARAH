...
DefaultInputValues = {m0 -> 1400, m12 -> 300, TanBeta->10, TanBetaRinput-> 1.07, SignumMu ->1,SignumMuR ->-1, Azero -> 0,  vR->5500, Yv[1,1]-> 0.1, Yv[1,2]->0.147*10^-8, Yv[1,3]->0.167*10^-8, Yv[2,1]->0, Yv[2,2]->0.1, Yv[2,3]->0, Yv[3,1]->0.162*10^-7, Yv[3,2]->0,Yv[3,3]->0.1, Ys[1,1]->0.3, Ys[2,2]->0.3, Ys[3,3]->0.3}; 

...
DEFINITION[EWSB][VEVs]= 
  {{SHd0, {vdR, 1/Sqrt[2]},{vdI, \[ImaginaryI]/Sqrt[2]}, {sigmad, \[ImaginaryI]/Sqrt[2]},{phid,1/Sqrt[2]}},
   ...
   {SeL,  {vLL[3], 1/Sqrt[2]}, {vLI[1], \[ImaginaryI]/Sqrt[2]}, {sigmaL, \[ImaginaryI]/Sqrt[2]},{phiL,1/Sqrt[2]}},
   {SeR,  {vLR[3], 1/Sqrt[2]}, {vRI[1], \[ImaginaryI]/Sqrt[2]}, {sigmaR, \[ImaginaryI]/Sqrt[2]},{phiR,1/Sqrt[2]}},
   {SHdm, {0, 1/Sqrt[2]}, {sigmaM, \[ImaginaryI]/Sqrt[2]},{phiM,1/Sqrt[2]}},
   {SHup, {0, 1/Sqrt[2]}, {sigmaP, \[ImaginaryI]/Sqrt[2]},{phiP,1/Sqrt[2]}},
   {SvL,  {vVL[3], 1/Sqrt[2]}, {sigmaV, \[ImaginaryI]/Sqrt[2]},{phiV,1/Sqrt[2]}},
   {SuLr, {vTL[3], 1/Sqrt[2]}, {sigmauLr, \[ImaginaryI]/Sqrt[2]},{phiuLr,1/Sqrt[2]}},
   {SuRr, {vTR[3], 1/Sqrt[2]}, {sigmauRr, \[ImaginaryI]/Sqrt[2]},{phiuRr,1/Sqrt[2]}},
   ...
   {SdLr, {vBL[3], 1/Sqrt[2]}, {sigmadLr, \[ImaginaryI]/Sqrt[2]},{phidLr,1/Sqrt[2]}},
   {SdRr, {vBR[3], 1/Sqrt[2]}, {sigmadRr, \[ImaginaryI]/Sqrt[2]},{phidRr,1/Sqrt[2]}},
...
DEFINITION[EWSB][VEVs]= 
  {{SHd0, {vdR, 1/Sqrt[2]}, {sigmad, \[ImaginaryI]/Sqrt[2]},{phid,1/Sqrt[2]}},
   ...
   {SeL,  {vLL[3], 1/Sqrt[2]},  {sigmaL, \[ImaginaryI]/Sqrt[2]},{phiL,1/Sqrt[2]}},
   {SeR,  {vLR[3], 1/Sqrt[2]},  {sigmaR, \[ImaginaryI]/Sqrt[2]},{phiR,1/Sqrt[2]}},
   {SHdm, {0, 1/Sqrt[2]}, {sigmaM, \[ImaginaryI]/Sqrt[2]},{phiM,1/Sqrt[2]}},
   {SHup, {0, 1/Sqrt[2]}, {sigmaP, \[ImaginaryI]/Sqrt[2]},{phiP,1/Sqrt[2]}},
   {SvL,  {vVL[3], 1/Sqrt[2]}, {sigmaV, \[ImaginaryI]/Sqrt[2]},{phiV,1/Sqrt[2]}},
   {SuLr, {vTL[3], 1/Sqrt[2]}, {sigmauLr, \[ImaginaryI]/Sqrt[2]},{phiuLr,1/Sqrt[2]}},

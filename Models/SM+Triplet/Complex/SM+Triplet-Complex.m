...
Model`Name = "cTSM";
Model`NameLaTeX ="complex Triplet Extended Standard Model";
...
LagNoHC = -(mu2 conj[H].H  + 1/2 MT trip.trip  - 1/2 LT  epsTensor[lef1b,lef2] epsTensor[lef2b,lef3] epsTensor[lef3b,lef4] epsTensor[lef4b,lef1] trip.conj[trip].trip.conj[trip] \

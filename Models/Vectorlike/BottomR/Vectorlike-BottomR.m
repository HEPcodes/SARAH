...
Model`Name = "VLBottomR";
Model`NameLaTeX ="Standard Model with vector-like Bottom";
...
FermionFields[[6]] = {b1, 1, conj[dR1],     1/3, 1, -3};
FermionFields[[7]] = {b2, 1, conj[dR2],    -1/3, 1,  3};
...
LagHC =  -(Yd conj[H].d.q + Ye conj[H].e.l - Yu H.u.q  + Yb conj[H].b1.q + mB b1.b2 + mdB d.b2 );
...
DEFINITION[EWSB][MatterSector]=   
    {{{{dL,conj[dR2]}, {conj[dR],conj[dR1]}}, {{DL,Vd}, {DR,Ud}}},

...
Model`Name = "VLBottomY";
Model`NameLaTeX ="Standard Model with vector-like Bottom and Y";
...
FermionFields[[6]] = {q1, 1, {bL1, Y1},     -5/6, 2,  3};
FermionFields[[7]] = {q2, 1, {-Y2, bL2},    5/6, 2, -3};
...
LagHC =  -(Yd conj[H].d.q + Ye conj[H].e.l - Yu H.u.q  + Yb H.d.q1 + mQ q1.q2 );

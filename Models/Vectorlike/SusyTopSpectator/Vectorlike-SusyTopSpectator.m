...
Model`Name = "VectorlikeTopSpectator";
Model`NameLaTeX ="MSSM with vectorlike top quarks and spectator fields";
Model`Authors = "F.Staub";
Model`Date = "2015-03-30";
...
SuperFields[[10]] = {q1,  1, {tL1,  bL1},    1/6, 2, 3, RpM};
SuperFields[[11]] = {q2,  1, {bL2,  tL2},    -1/6, 2, -3, RpM};  

SuperFields[[12]] = {tau1, 1, conj[tauR1],    1, 1,  1, RpM};
SuperFields[[13]] = {tau2, 1, conj[tauR2],    -1, 1,  1, RpM};
...
SuperPotential = Yu u.q.Hu - Yd d.q.Hd - Ye e.l.Hd + \[Mu] Hu.Hd + Yt t1.q.Hu + mT t1.t2  + mQ q1.q2 + mTau tau1.tau2 + mUT u.t2 ;
...
{    {{SdL, SdR}, {Sd, ZD}},
     ...
     {{SeL, SeR}, {Se, ZE}},
     {{StL1, conj[StL2]}, {StpL, ZUp}},
     {{SbL1, conj[SbL2]}, {SbpL, ZDp}},
     {{StauR1, conj[StauR2]}, {SepL, ZEp}},
     {{phid, phiu}, {hh, ZH}},
     {{sigmad, sigmau}, {Ah, ZA}},

...
Write2LPoleHeader:=Block[{i,j},WriteString[spheno2LP,"Module Pole2L_"<>ModelName<>" \n \n"];
...
Write2LPoleFunction[nh_,dynamic_,setofdiags_]:=Block[{types,ntypes,dcount,diag,ndiags,ps,ddata,pdesc,funcdesc,coupdescs,i,j,k,ii,argstring,string,string1,string2,prefactorstring,numberofcouplings,fcouptypes,fcount,indstring,prefactorlist,prefactormasslist,fermionmassstring,fermionandstring,tempmassstring,numericalprefactors,fermionmassstrings,fermionandstrings,labelstrings,tdimMatrix,ngen,fermionmassespresent},
...
If[ngen>1,WriteString[spheno2LP,"temptad=temptad*oo16Pi2*oo16Pi2\n"];
WriteString[spheno2LP,"tad2L=matmul(temptad,"<>SPhenoForm[HiggsMixingMatrix]<>")\n"];,WriteString[spheno2LP,"tad2L=temptad*oo16Pi2*oo16Pi2\n"];];
WriteString[spheno2LP,"! ----------------------------\n"];
...
,
WriteString[spheno2LP,"Pi2S(1,1)=tempcont(1,1)*oo16Pi2*oo16Pi2\n"];
];
...
,
If[ngen>0,WriteString[spheno2LP,"Pi2P(1,1)=tempcontah(1,1)*oo16Pi2*oo16Pi2\n"];];
];

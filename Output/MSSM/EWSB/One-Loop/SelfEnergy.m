{{Sd, 4*Cp[USd[{gO1}], conj[USd[{gO2}]], conj[VWm], VWm]*
   ...
   sum[gI1, 1, 2, A0[Mass2[hh[{gI1}]]]*Cp[USd[{gO1}], conj[USd[{gO2}]], 
       hh[{gI1}], hh[{gI1}]]]/2 - sum[gI1, 1, 3, A0[Mass2[Sv[{gI1}]]]*
     Cp[USd[{gO1}], conj[USd[{gO2}]], conj[Sv[{gI1}]], Sv[{gI1}]]] - 
   ...
   sum[gI2, 1, 6, conj[Cp[conj[USd[{gO2}]], VZ, Sd[{gI2}]]]*
     ...
     Cp[conj[USd[{gO1}]], VWm, Su[{gI2}]]*F0[p^2, Mass2[Su[{gI2}]], 
      Mass2[VWm]]]}, {Sv, 4*Cp[USv[{gO1}], conj[USv[{gO2}]], conj[VWm], VWm]*
    (A0[Mass2[VWm]] - (rMS*Mass2[VWm])/2) + 
   ...
   sum[gI2, 1, 3, conj[Cp[conj[USv[{gO2}]], VZ, Sv[{gI2}]]]*
    ...
    conj[Cp[conj[USv[{gO2}]], conj[VWm], Se[{gI2}]]]*
     Cp[conj[USv[{gO1}]], conj[VWm], Se[{gI2}]]*F0[p^2, Mass2[Se[{gI2}]], 
      Mass2[VWm]]]}, {Su, 4*Cp[USu[{gO1}], conj[USu[{gO2}]], conj[VWm], VWm]*
    (A0[Mass2[VWm]] - (rMS*Mass2[VWm])/2) + 
   ...
   sum[gI2, 1, 6, conj[Cp[conj[USu[{gO2}]], VZ, Su[{gI2}]]]*
     Cp[conj[USu[{gO1}]], VZ, Su[{gI2}]]*F0[p^2, Mass2[Su[{gI2}]], 
      Mass2[VZ]]]}, {Se, 4*Cp[USe[{gO1}], conj[USe[{gO2}]], conj[VWm], VWm]*
    (A0[Mass2[VWm]] - (rMS*Mass2[VWm])/2) + 
   ...
   sum[gI1, 1, 2, A0[Mass2[hh[{gI1}]]]*Cp[USe[{gO1}], conj[USe[{gO2}]], 
       hh[{gI1}], hh[{gI1}]]]/2 - sum[gI1, 1, 3, A0[Mass2[Sv[{gI1}]]]*
     Cp[USe[{gO1}], conj[USe[{gO2}]], conj[Sv[{gI1}]], Sv[{gI1}]]] + 
   sum[gI1, 1, 3, sum[gI2, 1, 2, B0[p^2, Mass2[Sv[{gI1}]], Mass2[Hpm[{gI2}]]]*
   ...
   sum[gI2, 1, 6, conj[Cp[conj[USe[{gO2}]], VZ, Se[{gI2}]]]*
     Cp[conj[USe[{gO1}]], VZ, Se[{gI2}]]*F0[p^2, Mass2[Se[{gI2}]], 
      Mass2[VZ]]]}, {hh, 2*(-rMS/2 + B0[p^2, Mass2[VZ], Mass2[VZ]])*
   ...
   B0[p^2, Mass2[gZ], Mass2[gZ]]*Cp[Uhh[{gO1}], bar[gZ], gZ]*
    Cp[Uhh[{gO2}], bar[gZ], gZ] + 4*Cp[Uhh[{gO1}], Uhh[{gO2}], conj[VWm], 
   ...
   sum[gI1, 1, 2, A0[Mass2[hh[{gI1}]]]*Cp[Uhh[{gO1}], Uhh[{gO2}], hh[{gI1}], 
      ...
      B0[p^2, Mass2[Ah[{gI1}]], Mass2[Ah[{gI2}]]]*
   ...
   sum[gI1, 1, 4, sum[gI2, 1, 4, G0[p^2, Mass2[Chi[{gI1}]], 
 ...
 {Ah, -(B0[p^2, Mass2[gWm], Mass2[gWm]]*Cp[UAh[{gO1}], bar[gWm], gWm]*
   ...
   2*sum[gI2, 1, 2, conj[Cp[UAh[{gO2}], conj[VWm], Hpm[{gI2}]]]*
      Cp[UAh[{gO1}], conj[VWm], Hpm[{gI2}]]*F0[p^2, Mass2[Hpm[{gI2}]], 
       Mass2[VWm]]]}, {Hpm, 4*(-rMS/2 + B0[p^2, 0, Mass2[VWm]])*
   ...
   sum[gI1, 1, 4, sum[gI2, 1, 2, G0[p^2, Mass2[Chi[{gI1}]], 
   ...
   sum[gI2, 1, 2, conj[Cp[conj[UHpm[{gO2}]], VZ, Hpm[{gI2}]]]*
     Cp[conj[UHpm[{gO1}]], VZ, Hpm[{gI2}]]*F0[p^2, Mass2[Hpm[{gI2}]], 
      Mass2[VZ]]]}, 
 {L0, {2*sum[gI1, 1, 2, sum[gI2, 1, 2, B0[p^2, Mass2[Cha[{gI2}]], 
         Mass2[Hpm[{gI1}]]]*conj[Cp[UChi[{gO2}], conj[Hpm[{gI1}]], 
           Cha[{gI2}]][PL]]*Mass[Cha[{gI2}]]*
        Cp[UChi[{gO1}], conj[Hpm[{gI1}]], Cha[{gI2}]][PR]]] + 
    ...
    2*sum[gI1, 1, 3, sum[gI2, 1, 3, B0[p^2, Mass2[Fv[{gI2}]], 
         ...
         PR]]] + sum[gI1, 1, 4, Mass[Chi[{gI1}]]*sum[gI2, 1, 2, 
   ...
   -sum[gI1, 1, 2, sum[gI2, 1, 2, B1[p^2, Mass2[Cha[{gI2}]], 
         Mass2[Hpm[{gI1}]]]*conj[Cp[UChi[{gO2}], conj[Hpm[{gI1}]], 
           Cha[{gI2}]][PR]]*Cp[UChi[{gO1}], conj[Hpm[{gI1}]], Cha[{gI2}]][
         PR]]] - sum[gI1, 1, 2, sum[gI2, 1, 4, 
       B1[p^2, Mass2[Chi[{gI2}]], Mass2[hh[{gI1}]]]*
    ...
    sum[gI1, 1, 4, sum[gI2, 1, 2, B1[p^2, Mass2[Chi[{gI1}]], 
   ...
   -sum[gI1, 1, 2, sum[gI2, 1, 2, B1[p^2, Mass2[Cha[{gI2}]], 
         Mass2[Hpm[{gI1}]]]*conj[Cp[UChi[{gO2}], conj[Hpm[{gI1}]], 
           Cha[{gI2}]][PL]]*Cp[UChi[{gO1}], conj[Hpm[{gI1}]], Cha[{gI2}]][
         PL]]] - sum[gI1, 1, 2, sum[gI2, 1, 4, 
       B1[p^2, Mass2[Chi[{gI2}]], Mass2[hh[{gI1}]]]*
 ...
 {Cha, {sum[gI1, 1, 2, Mass[Cha[{gI1}]]*sum[gI2, 1, 2, 
    ...
    sum[gI1, 1, 2, sum[gI2, 1, 2, B0[p^2, Mass2[Cha[{gI2}]], 
        Mass2[hh[{gI1}]]]*conj[Cp[bar[UCha[{gO2}]], hh[{gI1}], Cha[{gI2}]][
         PL]]*Mass[Cha[{gI2}]]*Cp[bar[UCha[{gO1}]], hh[{gI1}], Cha[{gI2}]][
        PR]]] + sum[gI1, 1, 2, sum[gI2, 1, 4, 
      B0[p^2, Mass2[Chi[{gI2}]], Mass2[Hpm[{gI1}]]]*
       conj[Cp[bar[UCha[{gO2}]], Hpm[{gI1}], Chi[{gI2}]][PL]]*
       Mass[Chi[{gI2}]]*Cp[bar[UCha[{gO1}]], Hpm[{gI1}], Chi[{gI2}]][PR]]] + 
    sum[gI1, 1, 3, sum[gI2, 1, 3, B0[p^2, Mass2[Fe[{gI2}]], Mass2[Sv[{gI1}]]]*
 ...
 {Fe, {sum[gI1, 1, 2, sum[gI2, 1, 3, B0[p^2, Mass2[Fe[{gI2}]], 
        Mass2[hh[{gI1}]]]*conj[Cp[bar[UFe[{gO2}]], hh[{gI1}], Fe[{gI2}]][PL]]*
       Mass[Fe[{gI2}]]*Cp[bar[UFe[{gO1}]], hh[{gI1}], Fe[{gI2}]][PR]]] + 
    sum[gI1, 1, 2, sum[gI2, 1, 3, B0[p^2, Mass2[Fv[{gI2}]], 
        Mass2[Hpm[{gI1}]]]*conj[Cp[bar[UFe[{gO2}]], Hpm[{gI1}], Fv[{gI2}]][
         PL]]*Mass[Fv[{gI2}]]*Cp[bar[UFe[{gO1}]], Hpm[{gI1}], Fv[{gI2}]][
        PR]]] + sum[gI1, 1, 3, Mass[Fe[{gI1}]]*sum[gI2, 1, 2, 
       B0[p^2, Mass2[Fe[{gI1}]], Mass2[Ah[{gI2}]]]*
        conj[Cp[bar[UFe[{gO2}]], Fe[{gI1}], Ah[{gI2}]][PL]]*
        Cp[bar[UFe[{gO1}]], Fe[{gI1}], Ah[{gI2}]][PR]]] + 
    sum[gI1, 1, 3, sum[gI2, 1, 2, B0[p^2, Mass2[Cha[{gI2}]], 
        Mass2[Sv[{gI1}]]]*conj[Cp[bar[UFe[{gO2}]], Sv[{gI1}], Cha[{gI2}]][
         PL]]*Mass[Cha[{gI2}]]*Cp[bar[UFe[{gO1}]], Sv[{gI1}], Cha[{gI2}]][
        PR]]] + sum[gI1, 1, 6, sum[gI2, 1, 4, 
   ...
   -sum[gI1, 1, 2, sum[gI2, 1, 3, B1[p^2, Mass2[Fe[{gI2}]], Mass2[hh[{gI1}]]]*
    ...
    sum[gI1, 1, 6, sum[gI2, 1, 4, B1[p^2, Mass2[Chi[{gI2}]], 
 ...
 {Fd, {sum[gI1, 1, 2, sum[gI2, 1, 3, B0[p^2, Mass2[Fd[{gI2}]], 
        Mass2[hh[{gI1}]]]*conj[Cp[bar[UFd[{gO2}]], hh[{gI1}], Fd[{gI2}]][PL]]*
       Mass[Fd[{gI2}]]*Cp[bar[UFd[{gO1}]], hh[{gI1}], Fd[{gI2}]][PR]]] + 
    sum[gI1, 1, 2, sum[gI2, 1, 3, B0[p^2, Mass2[Fu[{gI2}]], 
        Mass2[Hpm[{gI1}]]]*conj[Cp[bar[UFd[{gO2}]], Hpm[{gI1}], Fu[{gI2}]][
         PL]]*Mass[Fu[{gI2}]]*Cp[bar[UFd[{gO1}]], Hpm[{gI1}], Fu[{gI2}]][
        PR]]] + sum[gI1, 1, 3, Mass[Fd[{gI1}]]*sum[gI2, 1, 2, 
 ...
 {Fu, {sum[gI1, 1, 2, sum[gI2, 1, 3, B0[p^2, Mass2[Fd[{gI2}]], 
    ...
    sum[gI1, 1, 2, sum[gI2, 1, 3, B0[p^2, Mass2[Fu[{gI2}]], Mass2[hh[{gI1}]]]*
    ...
    sum[gI1, 1, 6, sum[gI2, 1, 4, B0[p^2, Mass2[Chi[{gI2}]], 
   ...
   -sum[gI1, 1, 2, sum[gI2, 1, 3, B1[p^2, Mass2[Fd[{gI2}]], 
          ...
          PR]]]/2 - sum[gI1, 1, 2, sum[gI2, 1, 3, 
       B1[p^2, Mass2[Fu[{gI2}]], Mass2[hh[{gI1}]]]*
        conj[Cp[bar[UFu[{gO2}]], hh[{gI1}], Fu[{gI2}]][PR]]*
        Cp[bar[UFu[{gO1}]], hh[{gI1}], Fu[{gI2}]][PR]]]/2 - 
    sum[gI1, 1, 2, sum[gI2, 1, 6, B1[p^2, Mass2[Cha[{gI1}]], 
         Mass2[Sd[{gI2}]]]*conj[Cp[bar[UFu[{gO2}]], bar[Cha[{gI1}]], 
           Sd[{gI2}]][PR]]*Cp[bar[UFu[{gO1}]], bar[Cha[{gI1}]], Sd[{gI2}]][
         PR]]]/2 - sum[gI1, 1, 3, sum[gI2, 1, 2, 
       B1[p^2, Mass2[Fu[{gI1}]], Mass2[Ah[{gI2}]]]*
   ...
   -sum[gI1, 1, 2, sum[gI2, 1, 3, B1[p^2, Mass2[Fd[{gI2}]], 
          ...
          PL]]]/2 - sum[gI1, 1, 2, sum[gI2, 1, 3, 
       B1[p^2, Mass2[Fu[{gI2}]], Mass2[hh[{gI1}]]]*
        conj[Cp[bar[UFu[{gO2}]], hh[{gI1}], Fu[{gI2}]][PL]]*
        Cp[bar[UFu[{gO1}]], hh[{gI1}], Fu[{gI2}]][PL]]]/2 - 
    sum[gI1, 1, 2, sum[gI2, 1, 6, B1[p^2, Mass2[Cha[{gI1}]], 
         Mass2[Sd[{gI2}]]]*conj[Cp[bar[UFu[{gO2}]], bar[Cha[{gI1}]], 
           Sd[{gI2}]][PL]]*Cp[bar[UFu[{gO1}]], bar[Cha[{gI1}]], Sd[{gI2}]][
         PL]]]/2 - sum[gI1, 1, 3, sum[gI2, 1, 2, 
       B1[p^2, Mass2[Fu[{gI1}]], Mass2[Ah[{gI2}]]]*
        conj[Cp[bar[UFu[{gO2}]], Fu[{gI1}], Ah[{gI2}]][PL]]*
 ...
 {Glu, {sum[gI1, 1, 6, sum[gI2, 1, 3, B0[p^2, Mass2[Fd[{gI2}]], 
        Mass2[Sd[{gI1}]]]*conj[Cp[Glu[{gO2}], conj[Sd[{gI1}]], Fd[{gI2}]][
         PL]]*Mass[Fd[{gI2}]]*Cp[Glu[{gO1}], conj[Sd[{gI1}]], Fd[{gI2}]][
        PR]]] + sum[gI1, 1, 6, sum[gI2, 1, 3, 
      B0[p^2, Mass2[Fu[{gI2}]], Mass2[Su[{gI1}]]]*
      ...
      H0[p^2, Mass2[Fv[{gI1}]], Mass2[Fv[{gI2}]]]*
       (conj[Cp[VZ, bar[Fv[{gI1}]], Fv[{gI2}]][PL]]*
        ...
        conj[Cp[VZ, bar[Fv[{gI1}]], Fv[{gI2}]][PR]]*
         Cp[VZ, bar[Fv[{gI1}]], Fv[{gI2}]][PR])]] + 
   sum[gI1, 1, 4, sum[gI2, 1, 4, 4*B0[p^2, Mass2[Chi[{gI1}]], 
